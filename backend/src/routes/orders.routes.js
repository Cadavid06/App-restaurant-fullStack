...
router.get("/order/:id", authRequired, authorizeRoles(1, 2, 3), getOrder);

router.put("/order/:id", authRequired, authorizeRoles(1, 2, 3), updateOrder);
router.delete("/order/:id", authRequired, authorizeRoles(1, 2, 3), deleteOrder);
